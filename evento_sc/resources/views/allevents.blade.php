...
@section('content')
    ...
    <head>
        ...
        <link
            href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;600;700;800&family=Poppins:wght@200;300;400;500;600&display=swap"
            rel="stylesheet">
                    ...
                    <div class="generic-title">
                        ...
                        @can('Book_an_event')
                            <div class="container event-shedule ">
                                <button class="btn btn" style="background-color: #FF5722;"><a  href="{{ route('myreservation') }}" class="text-light"
                                    ...
                                    @foreach ($events as $event)
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <p class="card-text"><small class="text-muted">{{ $event->date }}</small>
                                                </p>
                                                @can('Book_an_event')
                                                    <a href="{{ route('buy', [$event->id, $event->autoAccept]) }}"
                                                        class="btn btn-primary">Buy Ticket</a>
                                                @endcan
                                            </div>
                                        </div>
                                    @endforeach
